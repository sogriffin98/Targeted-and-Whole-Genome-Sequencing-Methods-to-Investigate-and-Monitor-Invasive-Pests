...
bcftools mpileup -f ./reference/GCF_912470025.1_iVesVel2.1_genomic.fna --annotate AD,DP ./bam/*primaryalignment.bam | bcftools call -m -v -f GQ --skip-variants indels -o ./vcf/AH_300_inds.vcf
```
