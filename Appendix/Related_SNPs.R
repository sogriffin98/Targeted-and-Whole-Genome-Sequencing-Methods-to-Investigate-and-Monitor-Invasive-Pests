...
related_input_trim <- related_input[, 1:(2 * 122 + 1)]
...
# Compare estimators
sink("estimators_output_SNPs_100iterations.txt")
...
write.table(relatedness_output$relatedness, "relatedness_output_terminal.txt", sep = ",", row.names = TRUE, col.names = TRUE)

# Import data
related_results <- read.table("relatedness_output_terminal.txt", header = TRUE, sep = ",", row.names = 1)
...
write.table(relatedness_output$relatedness, "relatedness_output.txt", sep = ",", row.names = TRUE, col.names = TRUE)
